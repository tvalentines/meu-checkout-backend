app.post('/api/pix', async (req, res) => {
    ...
    try {
        const data = new URLSearchParams({
            ...
            item_quantity_1: '1',
            item_amount_1: amount.toFixed(2), // Agora está seguro
            reference: reference || 'pedido_default'
        });
        ...
        console.error("Erro na API do PagSeguro:", error.response?.data || error.message);
